<div class="page-header row">
    <div class="header-logo-wrapper col-auto">
      <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="{{ asset('') }}assets/Admin-Mofi/assets/images/logo/logo.png" alt=""/><img class="img-fluid for-dark" src="{{ asset('') }}assets/Admin-Mofi/assets/images/logo/logo_light.png" alt=""/></a></div>
    </div>
    ...
    <div class="header-wrapper col m-0">
      <div class="row">
        ...
        <div class="header-logo-wrapper col-auto p-0">
          <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{ asset('') }}assets/Admin-Mofi/assets/images/logo/logo.png" alt=""></a></div>
          ...
          <ul class="nav-menus">
                ...
                <div class="Typeahead Typeahead--twitterUsers">
                  <div class="u-posRelative d-flex align-items-center">
                    <svg class="search-bg svg-color"> 
                      <use href="{{ asset('') }}assets/Admin-Mofi/assets/svg/icon-sprite.svg#search"></use>
                    </svg>
            ...
            <li class="fullscreen-body"><span>
                <svg id="maximize-screen">
                  <use href="{{ asset('') }}assets/Admin-Mofi/assets/svg/icon-sprite.svg#full-screen"></use>
                </svg></span>
            </li>
            <li>
              <div class="mode">
            ...
            <li class="profile-nav onhover-dropdown px-0 py-0">
              <div class="d-flex profile-media align-items-center"><img class="img-30" src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/profile.png" alt="">
