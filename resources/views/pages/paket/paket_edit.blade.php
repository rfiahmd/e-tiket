        ...
        <div class="card">
            ...
            <div class="card-body" style="margin-top: -3rem">
                ...
                <form class="row g-3 needs-validation custom-input" novalidate=""
                    action="{{ route('paket_edit', ['id' => $paket->paket_id]) }}" method="POST"
                    ...
                    <div class="col-6">
                        ...
                        <input class="form-control" name="nama_paket" id="validationCustom01" type="text"
                            value="{{ $paket->nama_paket }}" placeholder="Masukkan Nama Paket..." required="">
                            ...
                            <select class="form-select" name="wisata" id="validationCustom04" required="">
                                ...
                                @foreach ($wisata as $item)
                                    <option value="{{ $item->wisata_id }}"
                                        {{ $item->wisata_id == $paket->id_wisata ? 'selected' : '' }}>
                                        {{ $item->nama_wisata }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="harga" id="hargaPaket" inputmode="numeric"
                                placeholder="Masukkan Harga Paket..." value="{{ $paket->harga_paket }}" required="">
                        </div>
                    ...
                    <div class="col-12">
                        <label class="form-label" for="validationCustom04">Deskripsi<span
                                class="txt-danger">*</span></label>
                        <textarea id="editor" name="deskripsi" required>{{ $paket->deskripsi }}</textarea>
