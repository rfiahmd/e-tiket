...
<html lang="en">
  <head>
    ...
    <link
      ...
      type="image/png"
      sizes="32x32"
      href="{{ asset('trevlo') }}/assets/images/favicons/fav.png"
    />
    <link
      rel="icon"
      type="image/png"
    ...
    <link
      rel="stylesheet"
      href="{{ asset('trevlo') }}/assets/vendors/bootstrap/css/bootstrap.min.css"
    />
    <link
      rel="stylesheet"
      href="{{ asset('trevlo') }}/assets/vendors/bootstrap-select/bootstrap-select.min.css"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ asset('trevlo') }}/assets/vendors/nouislider/nouislider.min.css"
    />
    <link
      rel="stylesheet"
      href="{{ asset('trevlo') }}/assets/vendors/nouislider/nouislider.pips.css"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ asset('trevlo') }}/assets/vendors/daterangepicker-master/daterangepicker.css"
    />
    <link
      rel="stylesheet"
      href="{{ asset('trevlo') }}/assets/vendors/owl-carousel/css/owl.carousel.min.css"
    />
    <link
      rel="stylesheet"
      href="{{ asset('trevlo') }}/assets/vendors/owl-carousel/css/owl.theme.default.min.css"
    />
  ...
  <body class="custom-cursor">
    ...
    <div class="page-wrapper">
          ...
          <div class="main-header__inner">
            <div class="main-header__left">
              <div class="main-header__logo">
                <a href="index.html">
                  <img
                    src="{{ asset('trevlo') }}/assets/images/tiketsumenep2.png"
                    alt="Tiket Sumenep"
                    width="146"
                  />
                </a>
              ...
              <div class="main-header__right-right">
                ...
                <ul class="main-header__search-user">
                  <li class="main-header__search-user-item">
                    <a href="login.html" class="main-header__user"> Login </a>
                  </li>
                </ul>
      ...
      <section class="page-header">
        ...
        <div class="container">
          <h2
            class="page-header__title wow animated fadeInLeft"
            data-wow-delay="0s"
      ...
      <div class="mobile-nav__content">
        ...
        <div class="logo-box">
          <a href="index.html" aria-label="logo image"
            ><img src="{{ asset('trevlo') }}/assets/images/logo-dark.png" width="155" alt=""
          /></a>
        </div>
        <!-- /.logo-box -->
