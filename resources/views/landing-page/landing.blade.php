...
<body class="custom-cursor">
  ...
  <div class="preloader">
    <div class="preloader__image" style="background-image: url({{ asset('trevlo') }}/assets/images/favicons/fav.png);">
    </div>
  </div>
  <!-- /.preloader -->
              ...
              <div class="row">
                ...
                <div class="col-md-5">
                  <div class="banner-form__control">
                    ...
                    <input class="trevlo-datepicker" id="date" type="text" name="date"
                ...
                <a href="/detail/{{ $item->wisata_id }}" class="tour-listing__card-image-box">
                  <div class="cover">
                    <img src="{{ asset('pictures/wisata/'. $item->gambar_wisata) }}"
                      alt="{{ asset('trevlo') }}/assets/images/tours/tour-4-3.jpg" class="tour-listing__card-image">
                  </div>
                  ...
                  <div class="tour-listing-two__card-info">
                    <div>
                      <div class="tour-listing__card-location-box">
                        ...
                        <p class="tour-listing__card-location-text text-small">{{ $item->alamat_lengkap }}</p>
        ...
        <div class="row gutter-y-40">
          <div class="col-lg-8 col-md-9 col-sm-11 col-xl-7 wow animated fadeInUp" data-wow-delay="0.1s"
            ...
            <div class="footer-widget footer-widget--links">
              ...
              <p class="text-white">SumenepTiket hadir sebagai solusi inovatif bagi masyarakat untuk menikmati
                keindahan dan kekayaan budaya destinasi wisata di Kabupaten Sumenep. Melalui platform ini, pengunjung
                dapat dengan mudah mengakses informasi lengkap mengenai berbagai objek wisata, mulai dari situs sejarah,
                pantai yang memukau, hingga kuliner khas daerah. Dengan kemudahan pemesanan tiket berbasis online,
                SumenepTiket memastikan pengalaman wisata Anda lebih terencana dan nyaman, tanpa perlu repot mencari
                tiket secara manual. Jelajahi pesona Sumenep dengan lebih mudah dan praktis bersama SumenepTiket.</p>
            </div><!-- /.footer-widget -->
          </div><!-- /.col-md-6 -->
  ...
  <div class="mobile-nav__wrapper">
    ...
    <div class="mobile-nav__content">
      ...
      <div class="logo-box">
        <a href="index.html" aria-label="logo image"><img src="{{ asset('trevlo') }}/assets/images/logo-dark.png"
            width="155" alt="" /></a>
      </div>
      <!-- /.logo-box -->
