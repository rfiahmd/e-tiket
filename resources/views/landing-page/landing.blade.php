...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ asset('trevlo') }}/assets/images/favicons/apple-touch-icon.png" />
    ...
    <link rel="stylesheet"
        href="{{ asset('trevlo') }}/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.css" />
...
<body class="custom-cursor">
    ...
    <div class="preloader">
        <div class="preloader__image"
            style="background-image: url({{ asset('trevlo') }}/assets/images/favicons/fav.png);">
        </div>
    </div>
    <!-- /.preloader -->
    <div class="page-wrapper">
                ...
                <div class="main-header__inner">
                    <div class="main-header__left">
                        <div class="main-header__logo">
                            <a href="index.html">
                                <img src="{{ asset('trevlo') }}/assets/images/tiketsumenep2.png" alt="Tiket Sumenep"
                                    width="146">
                            </a>
                        </div>
        ...
        <section class="main-slider-three" id="home">
            <div class="container">
                <div class="main-slider-three__content">
                    <h5 class="main-slider-three__sub-title wow fadeInUp" data-wow-delay="200ms">Selamat Datang di
                        SUMENEP</h5>
                    <h3 class="main-slider-three__title wow fadeInUp" data-wow-delay="300ms">Cara Baru <br>Untuk
                        Berwisata</h3>
                ...
                <div class="banner-form wow fadeInUp" data-wow-delay="300ms">
                    <div class="container">
                        <form class="banner-form__wrapper"
                            action="https://www.bracketweb.com/trevlo-html/tour-listing-top-search.html">
                            <div class="row">
                                <div class="col-md-5">
                                ...
                                <div class="col-md-5">
                                    <div class="banner-form__control">
                                        ...
                                        <input class="trevlo-datepicker" id="date" type="text"
            ...
            <div class="main-slider-three__shape-one"
                style="background-image: url({{ asset('trevlo') }}/assets/images/shapes/slider-3-shape-1.png);"></div>
            <div class="main-slider-three__image wow fadeInRight" data-wow-delay="200ms"
                style="background-image: url({{ asset('trevlo') }}/assets/images/backgrounds/banner.jpg);"></div>
        </section>
                    ...
                    @foreach ($wisata as $item)
                        ...
                        <div class="item">
                            <div class="tour-listing-two__card tour-listing__card">
                                <a href="/detail/{{ $item->wisata_id }}" class="tour-listing__card-image-box">
                                    <div class="cover">
                                        <img src="{{ asset('pictures/wisata/' . $item->gambar_wisata) }}"
                                            alt="{{ asset('trevlo') }}/assets/images/tours/tour-4-3.jpg"
                                            class="tour-listing__card-image">
                                    </div>
                                    <div class="tour-listing__card-btn-group tour-listing__card-btn-group-hide">
                                        <div class="tour-listing__card-discount @@innerExtraClassName">10% Off
                                        </div>
                                ...
                                <div class="tour-listing__card-status-box">
                                    <span class="tour-listing__card-status">Buka</span>
                                </div>

                                <div class="tour-listing-two__card-show-content">
                                    <h6 class="tour-listing-two__card-show-title tour-listing__card-title">
                                        {{ $item->kategori->nama_kategori }}
                                    </h6>
                                    <div class="tour-listing-two__card-show-title-box" style="margin-bottom: -20px">
                                        <h3 class="tour-listing-two__card-show-title tour-listing__card-title"><a
                                                href="/detail/{{ $item->wisata_id }}">{{ $item->nama_wisata }}</a>
                                        </h3>
                                        <p class="tour-listing-two__card-show-title"
                                            style="margin: -20px 0 -20px 2px; font-size: 12px">
                                            {{ \Carbon\Carbon::parse($item->waktu_buka)->format('H:i') }}
                                            -
                                            {{ \Carbon\Carbon::parse($item->waktu_tutup)->format('H:i') }}
                                            WIB
                                        </p>
                                        {{-- <div class="tour-listing__card-camera-group">
                                            <a href="#"
                                                class="tour-listing-two__card-show-camera-btn tour-listing__card-camera-btn trevlo-image-popup"
                                    ...
                                    <div class="tour-listing-two__card-show-divider"></div>
                                    ...
                                    <div class="tour-listing__card-bottom">
                                        {{-- <div class="tour-listing__card-bottom-left">
                                            <div class="tour-listing__card-people">
                                                ...
                                                <p
                                                    class="tour-listing-two__card-show-people-text tour-listing__card-people-text text-small">
                                                    Harga
                                                </p>
                                            </div>
                                        </div><!-- /.tour-listing__card-bottom-left -->
                                        <div class="tour-listing__card-bottom-right">
                                            <h4 class="tour-listing-two__card-show-price tour-listing__card-price">
                                                Rp. 100.000
                                            </h4>
                                        </div> --}}
                                    </div>
                                    ...
                                    <div class="tour-listing__card-bottom">
                                        <div class="tour-listing__card-bottom-left">
                                            <div class="tour-listing__card-people">
                                                ...
                                                <a href="/detail/{{ $item->wisata_id }}"
                                                    class="tour-listing__card-people-text text-small">Detail</a>
                                            </div><!-- /.tour-listing__card-people -->
                                        </div><!-- /.tour-listing__card-bottom-left -->
                                        <div class="tour-listing__card-bottom-right">
                                            <h4 class="tour-listing-two__card-show-price tour-listing__card-price">Rp.
                                                100.000</h4>
        ...
        <section class="video-one" id="video">
            <div class="video-one__bg jarallax" data-jarallax data-speed="0.3" data-imgPosition="50% -100%"
                style="background-image: url({{ asset('trevlo') }}/assets/images/backgrounds/video-bg-1.jpg);"></div>
            <!-- /.video-one__bg -->
            <div class="container">
                <div class="video-one__content wow fadeInUp" data-wow-delay="100ms">
                    <h5 class="video-one__sub-title">Wisata Apa Aja Sih Yang Ada Di Sumenep?</h5>
                    <!-- /.video-one__sub-title -->
                    <h2 class="video-one__title">Beberapa Wisata Yang Sudah Diurutkan<br> Berdasarkan Kategori</h2>
                    <!-- /.video-one__title -->
                </div><!-- /.video-one__content -->
            </div><!-- /.container -->
        </section><!-- /.video-one -->
        <section class="tour-type">
            <div class="tour-type__bg"
                style="background-image: url({{ asset('trevlo') }}/assets/images/shapes/tour-type-bg.png);"></div>
            <!-- /.tour-type__bg -->
            <div class="container">
                <div class="sec-title text-center">
        ...
        <div class="client-carousel @@extraClassName">
            <div class="container">
                ...
                <div class="client-carousel__one trevlo-owl__carousel owl-theme owl-carousel"
                    data-owl-options='{
            "items": 5,
            "margin": 65,
            "smartSpeed": 700,
                ...
                "1200":{
                    ...
                    <div class="client-carousel__one__item">
                        <img class="client-carousel__one__item__normal"
                            src="{{ asset('trevlo') }}/assets/images/resources/brand-1-normal.png" alt="trevlo">
                        <img class="client-carousel__one__item__hover"
                            src="{{ asset('trevlo') }}/assets/images/resources/brand-1-hover.png" alt="trevlo">
                    </div><!-- /.owl-slide-item-->
                    <div class="client-carousel__one__item">
                        <img class="client-carousel__one__item__normal"
                            src="{{ asset('trevlo') }}/assets/images/resources/brand-1-normal.png" alt="trevlo">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 cta-two__btn wow fadeInUp" data-wow-delay="200ms">
                        <a href="contact.html" class="trevlo-btn trevloo-btn--base-three"><span>Start
                                Booking</span></a>
                    </div>
                </div>
            </div><!-- /.container -->
        ...
        <footer class="main-footer @@extraClassName">
            <div class="main-footer__bg"
                style="background-image: url({{ asset('trevlo') }}/assets/images/shapes/footer-bg-1-1.png);"></div>
            <!-- /.main-footer__bg -->
            <div class="container">
                <div class="main-footer__top row">
                    <div class="col-lg-4 col-sm-5">
                        <div class="main-footer__logo-box">
                            <img src="{{ asset('trevlo') }}/assets/images/tiketsuemnepfooter.png" alt="Tiket Sumenep"
                ...
                <div class="row gutter-y-40">
                    <div class="col-lg-8 col-md-9 col-sm-11 col-xl-7 wow animated fadeInUp" data-wow-delay="0.1s"
                        data-wow-duration="1500ms">
                        <div class="footer-widget footer-widget--links">
                            <h2 class="footer-widget__title">Tantang Kami</h2><!-- /.footer-widget__title -->
                            <p class="text-white">SumenepTiket hadir sebagai solusi inovatif bagi masyarakat untuk
                                menikmati
                                keindahan dan kekayaan budaya destinasi wisata di Kabupaten Sumenep. Melalui platform
                                ini, pengunjung
                                dapat dengan mudah mengakses informasi lengkap mengenai berbagai objek wisata, mulai
                                dari situs sejarah,
                                pantai yang memukau, hingga kuliner khas daerah. Dengan kemudahan pemesanan tiket
                                berbasis online,
                                SumenepTiket memastikan pengalaman wisata Anda lebih terencana dan nyaman, tanpa perlu
                                repot mencari
                                tiket secara manual. Jelajahi pesona Sumenep dengan lebih mudah dan praktis bersama
                                SumenepTiket.</p>
                        </div><!-- /.footer-widget -->
                    </div><!-- /.col-md-6 -->
                        ...
                        <div class="footer-widget footer-widget--contact">
                            ...
                            <ul class="footer-widget__info">
                                ...
                                <li> <i class="icon-envelope"></i> <a
                                        href="mailto:michael.mitc@example.com">septiabudiws@gmail.com</a></li>
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img
                        src="{{ asset('trevlo') }}/assets/images/logo-dark.png" width="155" alt="" /></a>
            </div>
            <!-- /.logo-box -->
