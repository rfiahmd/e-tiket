...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}assets/Admin-Mofi/assets/css/vendors/slick-theme.css">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}assets/Admin-Mofi/assets/css/vendors/datatables.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}assets/Admin-Mofi/assets/css/vendors/date-range-picker/flatpickr.min.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('') }}assets/Admin-Mofi/assets/css/vendors/bootstrap.css">
    <!-- App css-->
...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
        ...
        <!-- Page Header -->
        <x-header :titleHeader="$titleHeader"></x-header>
    ...
    <script src="{{ asset('') }}assets/Admin-Mofi/assets/js/datepicker/date-range-picker/datepicker-range-custom.js">
    </script>
    ...
    <script src="{{ asset('') }}assets/Admin-Mofi/assets/js/notify/custom-notify.js"></script>
    <script src="{{ asset('') }}assets/Admin-Mofi/assets/js/sweet-alert/sweetalert.min.js"></script>
    <script src="{{ asset('') }}assets/Admin-Mofi/assets/js/sweet-alert/app.js"></script>
    <script src="{{ asset('') }}assets/Admin-Mofi/assets/js/height-equal.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
