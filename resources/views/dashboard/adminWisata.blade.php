                ...
                <div class="card profile-greeting p-0">
                    <div class="card-body">
                        <div class="img-overlay">
                            ...
                            <p class="mt-2">Selamat datang di Sistem E-Tiket Wisata Sumenep, solusi mudah dan cepat untuk menikmati pesona wisata Sumenep!</p>
                            <p><strong>. . .</strong></p>
                        </div>
                    </div>
                </div>
                        ...
                        <ul class="notification-box">
                            <li class="d-flex">
                                <div class="flex-shrink-0 bg-light-primary"><img
                                        src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/icon/wallet.png"
                                        alt="Wallet"></div>
                            ...
                            <li class="d-flex">
                                <div class="flex-shrink-0 bg-light-info"><img
                                        src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/icon/shield-dne.png"
                                        alt="Shield-dne"></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex">
                                <div class="flex-shrink-0 bg-light-warning"> <img
                                        src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/icon/graph.png"
                                        alt="Graph"></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex">
                                <div class="flex-shrink-0 bg-light-tertiary"><img
                                        src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/icon/ticket-star.png"
                                        alt="Ticket-star"></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                                        <h5>Recently Paid</h5>
                                    </a>
                                ...
                                <ul class="appointments-user">
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><img
                                                src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/user/05.png"
                                                alt=""></div>
                                        <div class="flex-grow-1"><a href="private-chat.html">
                                                <h5>John Elliot</h5>
                                            </a>
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><img
                                                src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/user/06.png"
                                                alt=""></div>
                                        <div class="flex-grow-1"><a href="private-chat.html">
                                                <h5>Ashley Hart</h5>
                                            </a>
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><img
                                                src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/user/07.png"
                                                alt=""></div>
                                        <div class="flex-grow-1"><a href="private-chat.html">
                                                <h5>Anna lverson</h5>
                                            </a>
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><img
                                                src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/user/08.png"
                                                alt=""></div>
                                        <div class="flex-grow-1"><a href="private-chat.html">
                                                <h5>Dana Lemon</h5>
                                            </a>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/user/01.jpg"
                                                        alt="">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/user/02.jpg"
                                                        alt="">
                                                </div>
                                                <div class="flex-grow-1"><a href="product.html">
                                                        <h5>Ashley Hart</h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/user/03.jpg"
                                                        alt="">
                                                </div>
                                                <div class="flex-grow-1"><a href="product.html">
                                                        <h5>Anna lverson </h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="{{ asset('') }}assets/Admin-Mofi/assets/images/dashboard/user/04.jpg"
                                                        alt="">
                                                </div>
                                                <div class="flex-grow-1"><a href="product.html">
                                                        <h5>Ron Dayley</h5>
